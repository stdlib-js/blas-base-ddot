...
```javascript
ddot = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ddot@v0.4.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ddot@v0.4.1-umd/browser.js"></script>
```
